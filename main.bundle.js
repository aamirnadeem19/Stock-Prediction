...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__weather_service__ = __webpack_require__("../../../../../src/app/weather.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__weather_weather_data__ = __webpack_require__("../../../../../src/app/weather/weather-data.ts");
...
var WeatherService = /** @class */ (function () {
    ...
    WeatherService.prototype.getWeather = function (cityName) {
        for (var i = 0; i < __WEBPACK_IMPORTED_MODULE_0__weather_weather_data__["a" /* WEATHER */].length; i++) {
            if (__WEBPACK_IMPORTED_MODULE_0__weather_weather_data__["a" /* WEATHER */][i].cityName == cityName)
                return __WEBPACK_IMPORTED_MODULE_0__weather_weather_data__["a" /* WEATHER */][i];
        }
    };
...
var WEATHER = [
    { cityName: 'BLR', weatherValues: '1,2,3,4', searchTime: '' },
    { cityName: 'MUM', weatherValues: '200,300,400', searchTime: '' }
];
...
module.exports = "<div>\n  <input type=\"text\" name=\"\" value=\"\" #cityName>\n  <button type=\"button\" name=\"button\" (click)=\"getWeather(cityName.value)\">\n    Search\n  </button>\n  \n  <table>\n      <tr *ngIf=\"this.currentCityWeather !== undefined\">\n        <td>{{this.currentCityWeather.cityName}}</td>\n        <td *ngFor=\"let v of this.currentCityWeather.weatherValues.split(',')\">{{v}}</td>\n        <td>{{this.currentCityWeather.searchTime}}</td>\n   </table>\n  </div>\n  \n  Past Searches\n  <table>\n    <tr *ngFor=\"let pastCity of this.pastCityWeathers\">\n      <td>{{pastCity.cityName}}</td>\n      \n       <td *ngFor=\"let v of (pastCity.weatherValues).split(',')\">{{v}}</td>\n       <td>{{pastCity.searchTime}}</td>\n    </tr>\n  </table>\n\n  \n  \n  "
...
var WeatherComponent = /** @class */ (function () {
    ...
    WeatherComponent.prototype.getWeather = function (cityName) {
        ...
        this.pastCityWeathers.push(this.currentCityWeather);
        //for(var i=0; i < WEATHER.length;i++)
        //{
        // if(WEATHER[i].cityName == cityName)
        //  this.currentCityWeather=WEATHER[i];
        //}
    };
